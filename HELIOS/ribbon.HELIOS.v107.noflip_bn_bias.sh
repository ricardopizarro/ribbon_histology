...
#PBS -l feature=k80
#PBS -o $HOME/histo/weights/xplor/noflip_bn_bias/v107/out/$(USER)_$(JOBID)_$(JOBNAME).out
#PBS -e $HOME/histo/weights/xplor/noflip_bn_bias/v107/out/rpizarro_${MOAB_JOBID}_ribbon.err
